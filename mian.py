...
import random
from model.SAPNet import SAPNet
def get_parser():
    parser = argparse.ArgumentParser(description="Demo of argparse")
    parser.add_argument('--ds_name', default='PROTEINS')
    return parser
...
if __name__ == '__main__':
    ...
    acc, std, duration_mean = train_eval.cross_validation(ds_name,"SAPNet",dataset,seed,SAPNet,device,config,time_str)
